...
if accuracy > 0.85:
     ...
     os.system('curl --user admin:*** http://192.168.43.57:8080/job/Mt3_job3/build?token=success')

else:

     print('accuracy is: ',accuracy*100)
     os.system('curl --user admin:*** http://192.168.43.57:8080/job/Mt3_job4/build?token=failure')